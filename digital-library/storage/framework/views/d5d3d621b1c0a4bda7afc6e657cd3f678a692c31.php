	...
	<div class="container">
        ...
        <div class="row content vertical-center justify-content-center">
            ...
            <div class="col-md-4 prl-20">
                ...
                <img id="img_preview" class="mb-40 box-shadow-1" src="<?php echo e(asset('img/covers/sample.jpg')); ?>">
            ...
            <div class="col-md-6 prl-20">
                <!-- form start -->
                    <p class="mb-20"><?php echo e(date("l, d M Y")); ?></p>
                    <div class="form-group"> <!-- title -->
                        <input name="title" type="name" class="form-control" placeholder="Title" value="<?php echo e(old('title', '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group"> <!-- authors -->
                        <input name="authors" type="text" class="form-control" placeholder="Authors" value="<?php echo e(old('authors', '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group"> <!-- publisher -->
                        <input name="publisher" type="text" class="form-control" placeholder="Publisher" value="<?php echo e(old('publisher', '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group"> <!-- publication year -->
                        <input name="publication_year" type="text" class="form-control" placeholder="Publication Year" value="<?php echo e(old('publication_year', '')); ?>">
                        <?php $__errorArgs = ['publisher'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group"> <!-- ISBN -->
                        <input name="isbn" type="text" class="form-control" placeholder="ISBN" value="<?php echo e(old('isbn', '')); ?>">
                        <?php $__errorArgs = ['publisher'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group"> <!-- description -->
                        <textarea name="description" class="form-control" placeholder="Description"><?php echo e(old('description', '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-40"> <!-- url -->
                        <input name="url" type="text" class="form-control" placeholder="URL" value="<?php echo e(old('Url', '')); ?>">
                        <?php $__errorArgs = ['url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
        ...
        <div class="row">
                ...
                <div class="col-md-12" data-aos="fade-right" data-aos-duration="1200">
                    <ol>
                        ...
                        <p class="ptb-10 align-center"><img src="<?php echo e(asset('img/materials/guide-1.jpg')); ?>" class="mb-15" style="max-height:480px;"> <img src="<?php echo e(asset('img/materials/guide-3.jpeg')); ?>" style="max-height:480px;"></p>
                        ...
                        <p class="ptb-10 align-center"><img src="<?php echo e(asset('img/materials/guide-4.jpeg')); ?>" style="max-height:480px;"></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel - Digital Library Alt\digital-library\resources\views/books/create.blade.php ENDPATH**/ ?>